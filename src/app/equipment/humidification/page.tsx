      ...
      <main id="main-content">
        ...
        >
          ...
          >
            ...
            >
Humidification failures show up in your product.
              <br className="hidden lg:block" />{" "}
              <span className="text-[#D42027]">Before they show up on a report.</span>
            </h1>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[288px_1fr] gap-0">
                <div className="relative aspect-[4/3] lg:aspect-auto">
                  <Image
                    ...
                    alt="Commercial humidification system replacement by Gardner Air in Southern California"
                    fill
