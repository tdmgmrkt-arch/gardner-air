...
export const metadata: Metadata = {
  title: { absolute: "Commercial VRF & Ductless System Service | Gardner Air | SoCal" },
  description:
      ...
      <main id="main-content">
        ...
        >
          ...
          >
            ...
            >
              VRF platforms punish generalist contractors.
              <br className="hidden lg:block" />{" "}
              <span className="text-[#D42027]">Serviced by technicians who read the diagnostics.</span>
            </h1>
              ...
              <div className="flex flex-col gap-5">
                ...
                >
                  <div className="absolute top-4 left-4 z-10 flex items-center gap-2 rounded px-2.5 py-1.5 bg-black/55 backdrop-blur-sm border border-white/10">
                    ...
                    <span className="font-mono text-[9px] font-semibold uppercase tracking-[0.15em] text-white/90">Ductless · Commercial Interior</span>
                  </div>
                  <Image
