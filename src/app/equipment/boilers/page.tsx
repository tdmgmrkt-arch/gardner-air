...
export const metadata: Metadata = {
  title: { absolute: "Commercial Boiler Service | Gardner Air | Southern California" },
  description:
            ...
            <div className="rounded-2xl border border-[#D8D4CC] bg-white overflow-hidden">
              <div className="grid grid-cols-1 lg:grid-cols-[288px_1fr] gap-0">
                <div className="relative aspect-[4/3] lg:aspect-auto">
                  <Image
                    src="/equipment/boilers-replacement.webp"
                    alt="Commercial boiler replacement by Gardner Air in Southern California"
                    fill
