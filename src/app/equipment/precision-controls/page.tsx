...
export const metadata: Metadata = {
  title: { absolute: "Commercial HVAC Controls & Building Automation Service | Gardner Air" },
  description:
  ...
  openGraph: {
    title: "Commercial HVAC Controls & Building Automation Service | Gardner Air",
    description:
      "Gardner Air provides preventative maintenance and integration support for commercial HVAC controls and building automation systems across Southern California. Call (951) 696-4495.",
              ...
              <div className="flex flex-col gap-5">
                ...
                >
                  <div className="absolute top-4 left-4 z-10 flex items-center gap-2 rounded px-2.5 py-1.5 bg-black/55 backdrop-blur-sm border border-white/10">
                    ...
                    <span className="font-mono text-[9px] font-semibold uppercase tracking-[0.15em] text-white/90">BAS Panel · Mechanical Room</span>
                  </div>
                  <Image
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[288px_1fr] gap-0">
                <div className="relative aspect-[4/3] lg:aspect-auto">
                  <Image
                    ...
                    alt="Commercial HVAC controls and building automation replacement by Gardner Air in Southern California"
                    fill
