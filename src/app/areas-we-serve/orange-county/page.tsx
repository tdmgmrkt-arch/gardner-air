...
export const metadata: Metadata = {
  title: { absolute: "Commercial HVAC Orange County — Southern California | Gardner Air" },
  description:
    "Gardner Air delivers commercial HVAC preventative maintenance, repair, and installation across Orange County, CA — certified technicians, full-scope service, rapid response.",
  alternates: {
    canonical: "https://gardnerair.com/areas-we-serve/orange-county/",
  },
  openGraph: {
    title:
      "Commercial HVAC Orange County — Southern California | Gardner Air",
    description:
      "Gardner Air delivers commercial HVAC preventative maintenance, repair, and installation across Orange County, CA — certified technicians, full-scope service, rapid response.",
    url: "https://gardnerair.com/areas-we-serve/orange-county/",
  },
};
...
const localBusinessSchema = {
  ...
  name: "Gardner Air",
  description:
    "Commercial HVAC preventative maintenance, repair, replacement, and installation in Orange County, CA.",
  url: "https://gardnerair.com/areas-we-serve/orange-county/",
...
const breadcrumbSchema = {
  ...
  itemListElement: [
    ...
    { "@type": "ListItem", position: 3, name: "Orange County", item: "https://gardnerair.com/areas-we-serve/orange-county/" },
  ],
};

const FAQS: { q: string; a: string }[] = [
  {
    q: "What cities in Orange County does Gardner Air serve?",
    a: "Gardner Air serves commercial facilities throughout Orange County including Anaheim, Irvine, Santa Ana, Fullerton, Garden Grove, Orange, Costa Mesa, Huntington Beach, Mission Viejo, and surrounding communities. Contact our team if you\u2019re unsure whether your specific location falls within our service area.",
  },
  {
    q: "How does coastal humidity in Orange County affect commercial HVAC systems?",
    a: "Orange County\u2019s proximity to the Pacific introduces salt air and elevated humidity that accelerate coil corrosion and refrigerant circuit degradation. Regular preventative maintenance \u2014 including coil cleaning, refrigerant checks, and electrical inspections \u2014 is especially important for coastal commercial facilities. Gardner Air\u2019s full-scope maintenance visits are designed to catch these issues before they become system failures.",
  },
  {
    q: "Can Gardner Air support multi-site commercial accounts across Orange County?",
    a: "Yes. Gardner Air is built for multi-site and portfolio accounts. We coordinate maintenance schedules, standardize service reporting, and provide a single point of contact for all your Orange County locations. Contact us to discuss a program that fits your portfolio.",
  },
];
...
const AREA_TESTIMONIALS: TestimonialItem[] = [
  {
    ...
    company: "Commercial Facility · Orange County",
    industry: "Commercial",
  },
  {
    quote:
    ...
    company: "Commercial Real Estate · Orange County",
  ...
  },
  {
    ...
    company: "Industrial Facility · Orange County",
    industry: "Industrial",
  },
  {
    quote:
  ...
  return (
    <>
      ...
      <main id="main-content">
        ...
        {/* ------------------------------------------------------------------ */}
        <section
          aria-labelledby="oc-hero-heading"
          ...
          >
            <nav aria-label="Breadcrumb" className="mb-8">
              <ol className="flex flex-wrap items-center gap-2 text-[11px] font-mono font-semibold uppercase tracking-[0.15em] text-white/40">
                ...
                <li aria-hidden="true">/</li>
                <li className="text-white/60">Orange County</li>
              </ol>
            </nav>
            ...
            >
              ...
              <span className="text-[#D42027]">Orange County.</span>
            </h1>
            ...
            <p className="text-white/65 text-base lg:text-lg leading-relaxed max-w-xl mb-10">
              ...
              commercial facilities across Orange County &mdash; from Anaheim and Fullerton
              to Irvine and Mission Viejo.
            </p>
            ...
            >
              Schedule Service in Orange County
        ...
        {/* ------------------------------------------------------------------ */}
        <section
          aria-labelledby="oc-intro-heading"
          ...
          <div className="mx-auto max-w-[1280px] px-5 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-[1.1fr_1fr] gap-12 lg:gap-20 items-start">
              <div>
                ...
                >
                  Commercial HVAC for Orange County&rsquo;s Most Demanding Facilities
                </h2>
                <div className="flex flex-col gap-6 text-base lg:text-lg text-[#6B7280] leading-relaxed">
                  <p>
                    Orange County is home to a dense concentration of commercial real estate &mdash; Class A office
                    parks, industrial campuses, medical facilities, and retail centers that require consistent,
                    professional HVAC management. The coastal climate introduces salt air, humidity, and
                    condensation challenges that compound equipment wear if maintenance is deferred.
                  </p>
                  <p>
                    Gardner Air brings the same certified, factory-trained technical standard to Orange County
                    that Inland Empire clients have relied on for years. Whether you manage a single building
                    or a multi-site portfolio, our preventative maintenance programs are built for the reliability
                    Orange County facilities demand.
                  </p>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-5">
                <div className="relative aspect-[4/5] rounded-2xl overflow-hidden">
                  <Image
                    src="/Areas/Orange-County.webp"
                    alt="Commercial HVAC service in Orange County, California — Gardner Air"
                    fill
        ...
        <AreaServicesGrid
          headingId="oc-services-heading"
          heading="Full commercial HVAC scope for Orange County facilities."
        />
        ...
        {/* ------------------------------------------------------------------ */}
        <AreaWhyBlock
          eyebrow="Why Choose Gardner Air in Orange County"
          headingId="oc-body-heading"
          heading="A Maintenance Partner Built for Orange County&rsquo;s Commercial Standards"
          imageSrc="/gardner-partner2.webp"
          imageAlt="Gardner Air commercial HVAC technician partnering with an Orange County facility"
        >
          <p>
            Orange County commercial tenants and property owners hold HVAC contractors to a higher standard.
            Facilities managers in Class A buildings expect documented service visits, responsive
            communication, and technicians who arrive knowing their equipment. Gardner Air is structured
            exactly this way.
          </p>
          <p>
            Our maintenance program delivers full-scope visits &mdash; not time-block service &mdash; with
            same-day reports, consistent technician assignments, and honest repair-versus-replace guidance
            when equipment ages. We don&rsquo;t sell emergencies. We prevent them.
          </p>
          <p>
            Whether your Orange County facility runs chillers, rooftop package units, split systems, or
            precision cooling equipment, Gardner Air&rsquo;s factory-trained technicians are built to keep it
            performing reliably across every season.
          </p>
        </AreaWhyBlock>
        ...
        {/* ------------------------------------------------------------------ */}
        <section
          aria-label="Schedule HVAC service in Orange County"
        ...
        >
          ...
          <div className="relative mx-auto max-w-[1280px] px-5 sm:px-6 lg:px-8">
            <div className="max-w-2xl">
              ...
              >
                Ready to Protect Your Orange County Building&rsquo;s HVAC System?
              </h2>
              <p className="text-white/65 text-base leading-relaxed mb-8">
                Gardner Air&rsquo;s team serves commercial facilities throughout Orange County.
        ...
        <Testimonials
          ...
          heading="What Orange County clients say."
        ...
        {/* ------------------------------------------------------------------ */}
        <section
          aria-labelledby="oc-faq-heading"
        ...
        >
          <div className="mx-auto max-w-[1280px] px-5 sm:px-6 lg:px-8">
            ...
            >
              Frequently Asked Questions About HVAC Service in Orange County
            </h2>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] divide-y lg:divide-y-0 lg:divide-x divide-[#D8D4CC]">
                <div className="p-8 lg:p-10">
                  ...
                  <p className="text-base text-[#6B7280] leading-relaxed">
                    ...
                    If you&rsquo;re in Orange County and need to discuss scope, equipment, or scheduling,
                    reach out directly.
                  </p>
                </div>
        ...
        <section
          id="oc-contact"
          aria-labelledby="oc-form-heading"
          ...
          <div className="mx-auto max-w-[1280px] px-5 sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-[1.3fr_1fr] gap-12 lg:gap-20 items-start">
              ...
              <div className="bg-white rounded-2xl p-8 lg:p-10 border border-[#D8D4CC]">
                <ContactForm
                  headline="Schedule HVAC Service in Orange County"
